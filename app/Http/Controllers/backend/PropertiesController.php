...
class PropertiesController extends Controller
{
    ...
    public function getproperty(){
        $property = Properties::orderBy('id', 'DESC')->get();
        return $property;
    }
    public function sorting($name, $slug){

        if($name == 'owner'){
            if($slug == 'true'){
                $property = Properties::orderBy('owner','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('owner','DESC')->get();
                return $property;
            }
        }else if($name == 'appr_val'){
            if($slug == 'true'){
                $property = Properties::orderBy('appraised_value','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('appraised_value','DESC')->get();
                return $property;
            }
        }else if($name == 'property'){
            if($slug == 'true'){
                $property = Properties::orderBy('address','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('address','DESC')->get();
                return $property;
            }
        }else if($name == 'appr_date'){
            if($slug == 'true'){
                $property = Properties::orderBy('appraised_date','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('appraised_date','DESC')->get();
                return $property;
            }
        }else if($name == 'lender'){
            if($slug == 'true'){
                $property = Properties::orderBy('bank','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('bank','DESC')->get();
                return $property;
            }
        }else if($name == 'starting_principle'){
            if($slug == 'true'){
                $property = Properties::orderBy('starting_principle','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('starting_principle','DESC')->get();
                return $property;
            }
        }else if($name == 'loan_origination_date'){
            if($slug == 'true'){
                $property = Properties::orderBy('loan','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('loan','DESC')->get();
                return $property;
            }
        }else if($name == 'monthly_amount_due'){
            if($slug == 'true'){
                $property = Properties::orderBy('monthly_amount_due','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('monthly_amount_due','DESC')->get();
                return $property;
            }
        }else if($name == 'current_bal'){
            if($slug == 'true'){
                $property = Properties::orderBy('current_bal','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('current_bal','DESC')->get();
                return $property;
            }
        }else if($name == 'escrow_bal'){
            if($slug == 'true'){
                $property = Properties::orderBy('escrow_bal','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('escrow_bal','DESC')->get();
                return $property;
            }
        }else if($name == 'maturity_date'){
            if($slug == 'true'){
                $property = Properties::orderBy('maturity_date','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('maturity_date','DESC')->get();
                return $property;
            }
        }else if($name == 'term_leng'){
            if($slug == 'true'){
                $property = Properties::orderBy('term_leng','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('term_leng','DESC')->get();
                return $property;
            }
        }else if($name == 'rate'){
            if($slug == 'true'){
                $property = Properties::orderBy('rate','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('rate','DESC')->get();
                return $property;
            }
        }else if($name == 'interest_only_term'){
            if($slug == 'true'){
                $property = Properties::orderBy('interest_only_term','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('interest_only_term','DESC')->get();
                return $property;
            }
        }else if($name == 'renewal_date'){
            if($slug == 'true'){
                $property = Properties::orderBy('renewal_date','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('renewal_date','DESC')->get();
                return $property;
            }
        }else if($name == 'renewal_term'){
            if($slug == 'true'){
                $property = Properties::orderBy('renewal_term','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('renewal_term','DESC')->get();
                return $property;
            }
        }else if($name == 'ratechange_date'){
            if($slug == 'true'){
                $property = Properties::orderBy('rate_date','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('rate_date','DESC')->get();
                return $property;
            }
        }else if($name == 'ratechange_comment'){
            if($slug == 'true'){
                $property = Properties::orderBy('rate_comment','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('rate_comment','DESC')->get();
                return $property;
            }
        }else if($name == 'pre_paypment_penalties_end_date'){
            if($slug == 'true'){
                $property = Properties::orderBy('pre_paypment_penalties_end_date','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('pre_paypment_penalties_end_date','DESC')->get();
                return $property;
            }
        }else if($name == 'yield_maintenance'){
            if($slug == 'true'){
                $property = Properties::orderBy('yield_maintenance','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('yield_maintenance','DESC')->get();
                return $property;
            }
        }else if($name == 'prior_notice'){
            if($slug == 'true'){
                $property = Properties::orderBy('prior_notice','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('prior_notice','DESC')->get();
                return $property;
            }
        }else if($name == 'prepaymentdate_penalty'){
            if($slug == 'true'){
                $property = Properties::orderBy('prepayment_date_penalty','ASC')->get();
                return $property;
            }else{
                $property = Properties::orderBy('prepayment_date_penalty','DESC')->get();
                return $property;
            }
        }
